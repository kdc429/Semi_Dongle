...
public class GalleryCommentJoin {
	...
	private String galCommentReportStatus;
	//join문 이용하여 뽑을 내용
	...
	public GalleryCommentJoin(int groupNo, int galFileNo, int galCommentNo, int galCommentLevel, int memberNo,
			String galCommentContent, Date galCommentDate, int galCommentRef, String galCommentReportStatus,
			String groupMemberNickname, String groupMemberImageNewPath, String albumCode, String galFileNewPath,
			int galNo, String galMultiStatus) {
		super();
		...
		this.galCommentReportStatus = galCommentReportStatus;
	...
	public String getGalCommentReportStatus() {
		return galCommentReportStatus;
	}

	public void setGalCommentReportStatus(String galCommentReportStatus) {
		this.galCommentReportStatus = galCommentReportStatus;
	}
	...
	public String toString() {
		return "GalleryCommentJoin [groupNo=" + groupNo + ", galFileNo=" + galFileNo + ", galCommentNo=" + galCommentNo
				...
				+ ", galCommentReportStatus=" + galCommentReportStatus + ", groupMemberNickname=" + groupMemberNickname
				+ ", groupMemberImageNewPath=" + groupMemberImageNewPath + ", albumCode=" + albumCode
				+ ", galFileNewPath=" + galFileNewPath + ", galNo=" + galNo + ", galMultiStatus=" + galMultiStatus
				+ "]";
	}
