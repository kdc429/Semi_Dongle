...
public class GalleryPath {
   ...
   private String galReportStatus;
   //닉네임 조인하기
   ...
   public GalleryPath(int groupNo, String albumCode, int memberNo, int galNo, int galFileNo, String galFileOldPath,
		String galFileNewPath, String galFileContent, Date galEnrollDate, String galMultiStatus, String galReportStatus,
	...
	this.galReportStatus = galReportStatus;
...
public String getGalReportStatus() {
	return galReportStatus;
}


public void setGalReportStatus(String galReportStatus) {
	this.galReportStatus = galReportStatus;
}
...
@Override
   public String toString() {
      return " [동호회 번호: " + groupNo + " 앨범코드: " + albumCode + " 사진게시글 번호: " + galFileNo + "작성자 닉네임: "+groupMemberNickname + "작성자 프로필: "+ groupMemberImageNewPath
            ...
            +" *사진게시물등록번호: "+galNo+" 사진게시물 내용: "+galFileContent+" 다중파일 여부: "+galMultiStatus+" 신고여부: "+galReportStatus+"] ";
   }
