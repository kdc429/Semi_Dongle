...
/**
 * Servlet implementation class DeleteMemberViewServlet
 */
@WebServlet("/manager/deleteMemberView")
public class DeleteMemberViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteMemberViewServlet() {
        super();
