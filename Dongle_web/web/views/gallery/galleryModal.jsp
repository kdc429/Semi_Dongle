   ...
   <li class="level2" style="list-style:none;">
      ...
      <%}
         ...
         <%} %>
            ...
            <span>&nbsp;&nbsp;      </span>
            <%if((group.getMemberNo()==loginMember.getMemberNo())||gplist.get(0).getMemberNo()==loginMember.getMemberNo()){ %>
            ...
            $(function(){
               $('.btn-insert1').click(function(){
                  ...
                  $.ajax({
                     ...
                     type:"post",
                     success:function(data){
                    	 console.log(<%=gplist.get(0).getGalFileNo()%>);
                        if(data!=null)
                        {   
                           alert('댓글 등록 완료!');
                           $('.comment-editor').html(data);
