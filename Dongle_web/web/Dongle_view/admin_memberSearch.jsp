...
<section>
	...
	<div id="member-list-container">
		...
		<table id="tbl-member">
			<thead>
				<tr>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("memberId")&&flag.equals("true")?"false":"true"%>&rowValue=memberId&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						아이디				
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("memberName")&&flag.equals("true")?"false":"true"%>&rowValue=memberName&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						이름
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("gender")&&flag.equals("true")?"false":"true"%>&rowValue=gender&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						성별
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("ssn")&&flag.equals("true")?"false":"true"%>&rowValue=ssn&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						생년월일
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("phone")&&flag.equals("true")?"false":"true"%>&rowValue=phone&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						전화번호
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("address")&&flag.equals("true")?"false":"true"%>&rowValue=address&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						주소
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("email")&&flag.equals("true")?"false":"true"%>&rowValue=email&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						이메일
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("enrollDate")&&flag.equals("true")?"false":"true"%>&rowValue=enrollDate&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						가입일
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("blackList")&&flag.equals("true")?"false":"true"%>&rowValue=blackList&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						블랙 여부
					</th>
					<th onclick="location.href='<%=request.getContextPath() %>/admin/sortList?flag=<%=rowValue.equals("reportCount")&&flag.equals("true")?"false":"true"%>&rowValue=reportCount&member-searchType=<%=searchType %>&searchKeyword=<%=searchKeyword %>&rowValue=memberId'">
						신고 횟수
					</th>
				</tr>
